...
/*   Updated: 2025/12/23 20:55:59 by dande-je         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
struct UploadFileInfo {
  ...
  domain::value_objects::Path filePath;
...
struct UploadStatistics {
  ...
  domain::value_objects::Size totalSize;
  domain::value_objects::Size diskSpaceUsed;
  domain::value_objects::Size diskSpaceAvailable;
...
class UploadConfig {
 public:
  ...
  static const domain::value_objects::Size DEFAULT_MAX_FILE_SIZE;
  static const domain::value_objects::Size DEFAULT_MAX_TOTAL_SIZE;
  ...
  explicit UploadConfig(const domain::value_objects::Path& uploadDirectory);
  UploadConfig(const domain::value_objects::Path& uploadDirectory,
  ...
  void setMaxFileSize(const domain::value_objects::Size& maxSize);
  void setMaxTotalSize(const domain::value_objects::Size& maxSize);
  ...
  bool validateFileSize(const domain::value_objects::Size& fileSize) const;
  bool validateTotalSize(const domain::value_objects::Size& totalSize) const;
  ...
  // Cleanup
  bool cleanupOldFiles(int daysToKeep = 30) const;
  bool cleanupOrphanedFiles() const;
  bool cleanupTemporaryFiles() const;

  // Security
  bool scanForViruses(const domain::value_objects::Path& filePath) const;
  ...
  domain::value_objects::Path getFullPath(const std::string& filename) const;

  // Getters
  domain::value_objects::Path getUploadDirectory() const;
  domain::value_objects::Size getMaxFileSize() const;
  domain::value_objects::Size getMaxTotalSize() const;
 ...
 private:
  domain::value_objects::Path m_uploadDirectory;
  domain::value_objects::Size m_maxFileSize;
  domain::value_objects::Size m_maxTotalSize;
  ...
  mutable infrastructure::filesystem::FileHandler* m_fileHandler;
  mutable infrastructure::filesystem::DirectoryLister* m_directoryLister;
  mutable infrastructure::filesystem::PathResolver* m_pathResolver;
  ...
  bool generateThumbnail(const domain::value_objects::Path& thumbPath) const;
  bool applyWatermark(const domain::value_objects::Path& sourcePath,
                      const domain::value_objects::Path& watermarkedPath) const;
  bool encryptFile(const domain::value_objects::Path& sourcePath,
